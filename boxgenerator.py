...
def boxgenerator():
    ...
    for i in range(1,ykomponens):
        ...
        kfal2=kfal/2
        poinst3 = [[x3,y3+bfal2+kfal/2,z3], [x3,y3+bfal2+kfal/2,kfal], [x3,y3-bfal2+kfal/2,z2], [x3,y3-bfal2+kfal/2,kfal], [kfal,y3+bfal2+kfal/2,z3], [kfal,y3+bfal2+kfal/2,kfal], [kfal,y3-bfal2+kfal/2,z3], [kfal,y3-bfal2+kfal/2,kfal]]
        cloud3 = trimesh.points.PointCloud(poinst3)
        hull_mesh3 = cloud3.convex_hull
        hull_mesh = hull_mesh + hull_mesh3
